    ...
    for (;;)
    {
        ...
        else if (playerMove.size() == 1)
        {
            if (tolower(playerMove[0]) == 'x')
                ...
                return player->move(dir);
            else if (playerMove[0] == 'h' || playerMove[0] == 'H') //if the player types 'h' or 'H', it displays the history, then cout a message, then waits for the user to press enter, then redisplays the grid as it was before. No turn is taken until the player either moves or drops a pellet.
            {
